...
const double kGeneralBorderRadiusMedium = 15.0;
...
const double kIconSizeSmall = 10.0;
const double kBorderRadiusSmall = 10.0;
const double kBorderRadiusSmallest = 8.0;
const double kSizedBoxHeightSmall = 40;
