                        ...
                        itemBuilder: (context, index) {
                          return Row(
                            ...
                            children: [
                                      ...
                                      Row(
                                        children: [
                                          Text(orderData[index]['title'],
                                              style: (orderData[index]['status']!='pending')?Theme.of(context)
                                                  .textTheme
                                                  .textMedium
                                                  :Theme.of(context)
                                                  .textTheme
                              ...
                              (orderData[index]['status']=='current')?Text('Check My Package',style: Theme.of(context).textTheme.textMedium.copyWith(color: AppColor.primary),):const SizedBox()
                            ],
                          );
                        })
                  ],
